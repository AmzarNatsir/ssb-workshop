        ...
        <div class="content pb-0">
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto">
                    ...
                    <!-- start page header -->
                    <h6 class="mb-3 fs-14"> <a href="{{url('invoice')}}"><i class="ti ti-arrow-left me-1"></i>Invoices</a></h6>
                    <!-- end page header -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center justify-content-between border-1 border-bottom pb-3 mb-3">
                                <img src="{{URL::asset('build/img/logo.svg')}}" class="invoice-light-logo" width="200" alt="">
                                <img src="{{URL::asset('build/img/logo-white.svg')}}" class="dark-logo" width="200" alt="">
