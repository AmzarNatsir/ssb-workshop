        ...
        <div class="content pb-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        <a href="{{url('contacts')}}"><i class="ti ti-arrow-narrow-left me-1"></i>Back to Contacts</a>
                    </div>
                                    ...
                                    <div class="card border shadow-none mb-3">
                                        <div class="card-body p-3">
                                            <div class="d-flex flex-wrap row-gap-2">
                                                ...
                                                <div>
                                                    <h6 class="fw-medium mb-1 d-inline-flex align-items-center fs-14 flex-wrap">Meeting With <span class="avatar avatar-xs avatar-rounded mx-2"><img src="{{URL::asset('build/img/profiles/avatar-19.jpg')}}" alt="img"></span> Abraham</h6>
