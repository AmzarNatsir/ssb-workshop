        ...
        <div class="content pb-0">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        <a href="{{url('deals')}}"><i class="ti ti-arrow-narrow-left me-1"></i>Back to Deals</a>
                    </div>
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center">
                                    <span class="avatar avatar-xs rounded-circle me-2">
                                        <img src="{{URL::asset('build/img/users/avatar-3.jpg')}}" alt="" class="img-fluid rounded-circle w-auto h-auto">
                                    </span>
                                    <div>
