                ...
                <div class="col-lg-6 vh-100  overflow-y-auto overflow-x-hidden">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 mx-auto">
                            <form action="{{url('login')}}" class=" vh-100 d-flex justify-content-between flex-column p-4 pb-0">
                                ...
                                <div>
                                    ...
                                    <div class="mb-3">
                                        <p class="mb-0">Already have an account? <a href="{{url('login')}}" class="link-indigo fw-bold link-hover"> Sign In Instead</a></p>
                                    </div>
