                        ...
                        <div class="card-body pb-2">
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="d-flex align-items-center flex-wrap gap-2">
                                    ...
                                    <a href="{{url('chat')}}" class="action-icon btn btn-icon btn-sm btn-outline-light shadow">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center">
                                    <span class="avatar avatar-lg rounded-circle me-2 border">
                                        <img src="{{URL::asset('build/img/icons/company-icon-04.svg')}}" alt="" class="img-fluid w-auto h-auto">
                                    </span>
                                    <div>
                            ...
                            <div class="mb-3">
                                <div class="d-flex align-items-center">
                                    <span class="avatar avatar-lg rounded-circle me-2 border">
                                        <img src="{{URL::asset('build/img/icons/company-icon-05.svg')}}" alt="" class="img-fluid w-auto h-auto">
                                    </span>
                                    <div>
