                                        ...
                                        <div class="modal-body">
                                            <div class="auth-brand text-center mt-2 mb-3 position-relative top-0">
                                                <a href="{{url('index')}}" class="dark-logo">
                                                    <span><img src="{{URL::asset('build/img/logo.svg')}}" alt="dark logo" height="33"></span>
                                                </a>
                                                <a href="{{url('index')}}" class="invoice-light-logo">
                                                    <span><img src="{{URL::asset('build/img/logo-white.svg')}}" alt="logo" height="33"></span>
                                                </a>
                                            </div>
                                        ...
                                        <div class="modal-body">
                                            <div class="auth-brand text-center mt-2 mb-3 position-relative top-0">
                                                <a href="{{url('index')}}" class="logo-dark">
                                                    <span><img src="{{URL::asset('build/img/logo.svg')}}" alt="dark logo" height="22"></span>
                                                </a>
                                                <a href="{{url('index')}}" class="logo-light">
                                                    <span><img src="{{URL::asset('build/img/logo-white.svg')}}" alt="logo" height="22"></span>
                                                </a>
                                            </div>
