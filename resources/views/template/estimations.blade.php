            ...
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                ...
                <div class="d-flex align-items-center gap-2 flex-wrap">                                
                    <div class="d-flex align-items-center shadow p-1 rounded border view-icons bg-white">
                        <a href="{{url('estimations-list')}}" class="btn btn-sm p-1 border-0 fs-14"><i class="ti ti-list-tree"></i></a>
                        <a href="{{url('estimations')}}" class="flex-shrink-0 btn btn-sm p-1 border-0 ms-1 fs-14 active"><i class="ti ti-grid-dots"></i></a>
                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);"
                                            ...
                                            <img src="{{URL::asset('build/img/icons/company-icon-07.svg')}}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card kanban-card border mb-0 mt-3 shadow">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="avatar avatar-xs border p-1 rounded-circle d-flex align-items-center justify-content-center">
                                            <img src="{{URL::asset('build/img/icons/company-icon-03.svg')}}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card kanban-card border mb-0 mt-3 shadow">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="avatar avatar-xs border p-1 rounded-circle d-flex align-items-center justify-content-center">
                                            <img src="{{URL::asset('build/img/icons/company-icon-01.svg')}}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            <a href="javascript:void(0);"
                                                class="avatar rounded-circle border bg-white flex-shrink-0 me-2">
                                                <img src="{{URL::asset('build/img/priority/project-02.svg')}}"
                                                    class="w-auto h-auto" alt="">
                                            </a>
                                            <div>
                                                <h6 class="fw-medium fs-14 mb-1"><a
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="avatar avatar-xs border p-1 rounded-circle d-flex align-items-center justify-content-center">
                                            <img src="{{URL::asset('build/img/icons/company-icon-08.svg')}}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card kanban-card border mb-0 mt-3 shadow">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="avatar avatar-xs border p-1 rounded-circle d-flex align-items-center justify-content-center">
                                            <img src="{{URL::asset('build/img/icons/company-icon-02.svg')}}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card kanban-card border mb-0 mt-3 shadow">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="avatar avatar-xs border p-1 rounded-circle d-flex align-items-center justify-content-center">
                                            <img src="{{URL::asset('build/img/icons/company-icon-04.svg')}}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card kanban-card border mb-0 mt-3 shadow">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="avatar avatar-xs border p-1 rounded-circle d-flex align-items-center justify-content-center">
                                            <img src="{{URL::asset('build/img/icons/company-icon-05.svg')}}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card kanban-card border mb-0 mt-3 shadow">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="avatar avatar-xs border p-1 rounded-circle d-flex align-items-center justify-content-center">
                                            <img src="{{URL::asset('build/img/icons/company-icon-10.svg')}}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
