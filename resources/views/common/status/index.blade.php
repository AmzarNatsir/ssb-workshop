...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                <div>
                    <h4 class="mb-1">Status<span class="badge badge-soft-primary ms-2">{{ $count }}</span></h4>
            ...
            <div class="card border-0 rounded-0">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive custom-table">
                        <table class="table table-nowrap" id="status-table">
    ...
    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
        <div class="offcanvas-header border-bottom">
            <h5 class="fw-semibold">Add New Status</h5>
            <button type="button"
    ...
    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_edit">
        <div class="offcanvas-header border-bottom">
            <h5 class="fw-semibold">Edit Status</h5>
            <button type="button"
                class="btn-close custom-btn-close border p-1 me-0 d-flex align-items-center justify-content-center rounded-circle"
                data-bs-dismiss="offcanvas" aria-label="Close">
                <i class="ti ti-x"></i>
...
$(document).ready(function() {
    ...
    $('#offcanvas_add').on('show.bs.offcanvas', function() {
        $.get('{{ route("status.create") }}', function(data) {
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $.get('{{ route("status.index") }}/' + id + '/edit', function(data) {
