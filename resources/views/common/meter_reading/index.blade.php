...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="content pb-0">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                <div>
                    <h4 class="mb-1">Meter Readings<span class="badge badge-soft-primary ms-2">{{ $count }}</span></h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            <li class="breadcrumb-item"><a href="{{url('home')}}">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Meter Readings</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card border-0 rounded-0">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive custom-table">
                        <table class="table table-nowrap" id="meter-reading-table">
    ...
    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_add">
        <div class="offcanvas-header border-bottom">
            <h5 class="fw-semibold">Add New meter-reading</h5>
            <button type="button"
    ...
    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvas_edit">
        <div class="offcanvas-header border-bottom">
            <h5 class="fw-semibold">Edit meter-reading</h5>
            <button type="button"
                class="btn-close custom-btn-close border p-1 me-0 d-flex align-items-center justify-content-center rounded-circle"
                data-bs-dismiss="offcanvas" aria-label="Close">
                <i class="ti ti-x"></i>
...
$(document).ready(function() {
    ...
    let table = $('#meter-reading-table').DataTable({
        ajax: {
            url: '{{ route("meter-reading.datatables") }}',
            dataSrc: 'data'
        },
        columns: [
            {
    ...
    $('#offcanvas_add').on('show.bs.offcanvas', function() {
        $.get('{{ route("meter-reading.create") }}', function(data) {
    ...
    $(document).on('click', '.edit-btn', function() {
        ...
        $.get('{{ route("meter-reading.index") }}/' + id + '/edit', function(data) {
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '{{ route("meter-reading.index") }}/' + id,
                    method: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
...
function refreshTable() {
    $('#meter-reading-table').DataTable().ajax.reload();
}
</script>
@endpush
