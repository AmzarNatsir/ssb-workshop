    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                <div>
                    <h4 class="mb-1">Equipment<span class="badge badge-soft-primary ms-2">{{ $count }}</span></h4>
            ...
            <div class="card border-0 rounded-0">
                <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
                    ...
                    <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvas_add"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add New</a>
                </div>
                <div class="card-body">
                    ...
                    <div class="table-responsive custom-table">
                        <table class="table table-nowrap" id="unit-type-list">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th>KM End</th>
                                    <th>Standby/Idle</th>
                                    <th>Standby/Idle Info</th>
                                    <th>Breakdown</th>
                                    <th>Breakdown Info</th>
                                    <th>Mechanical Availibility</th>
                                    <th>Physical Availability</th>
                                    <th>Use Of Availability</th>
